...
export default class PointTypeView extends RadioGroupView {
  ...
  /**
   * @override
   * нарисовали разметку для видов транспорта
   */
  createHtml() {
    return html`
   ...
   * нарисавали разметку иконка плюс название транспорта
   */
   ...
   * составили список транспорта с разметкой
   */
   ...
   * @override
   * @param {string} value
   * сопоставили иконки с видом транспортра
   */
  setValue(value) {
